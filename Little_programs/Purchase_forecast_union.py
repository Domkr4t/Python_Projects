...
piece_snacks = ["Уши свиные в ассортименте 90г", "Чипсы Мистер Потато барбекю 40г", "Чипсы Мистер Потато оригинальные 40г", "Чипсы Мистер Потато острые 40г", "Чипсы Мистер Потато сметана/лук 40г", "Гренки Волнистые с чесноком 75г", "Креветка сушеная с солью  40г", "Креветка сушеная с чесноком и укропом 40г", "Гренки Барные с томатом,чесноком и зеленью 70г", "Семечки с солью 130г"]
